  ...
  <div id="hero" class="home">
    ...
    <div class="container">
      <div class="hero-content">
        <h1>I'm <span class="typed" data-typed-items="Bagas Alief, Designer, Developer, Freelancer, Photographer"></span></h1>
        <p>Designer, Developer, Freelancer, Photographer</p>

        <ul class="list-unstyled list-social">
          <li><a href="https://www.facebook.com/profile.php?id=100075776222589"><i class="bi bi-facebook"></i></a></li>
          <li><a href="https://twitter.com/Bamalaief?t=QhPYv3Lvvo1dnkpXQl53mg&s=09"><i class="bi bi-twitter"></i></a></li>
          <li><a href="https://www.instagram.com/bamalief/"><i class="bi bi-instagram"></i></a></li>
          <li><a href="https://www.linkedin.com/in/bagas-alief-8862ab222/"><i class="bi bi-linkedin"></i></a></li>
        </ul>
      </div>
    </div>
  </div><!-- End Hero -->
        ...
        <div class="row justify-content-between">
          ...
          <div class="col-lg-4 ">
            <div class="div-img-bg">
              <div class="about-img">
                <img src="assets/img/ayang.jpeg" class="img-responsive" alt="me">
              </div>
            </div>
          </div>
            ...
            <div class="col-lg-6">
              <div class="contact-contact">
                ...
                <ul class="contact-details">
                  <li><span>Jl. Swadaya</span></li>
                  <li><span>Depok, Indonesia</span></li>
                  <li><span>+62 81908256990</span></li>
                  <li><span>bemwayne7@gmail.com</span></li>
                </ul>
