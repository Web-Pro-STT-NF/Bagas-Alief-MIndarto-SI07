...
<head>
    ...
    <div class="bg-success"><br>
        <h1 class="text-center text-black">Form Body Mass Index</h1>
        <br>
    </div>
      ...
      <div class="container-fluid">
          ...
          <div class="col-12">
            ...
            <div class="card border-success">
              <div class="card-header bg-success">
                <h3 class="card-title text-black">Form BMI</h3>
              ...
              <br>
                ...
                <div class="form-group row">
                    <div class="offset-4 col-8">
                        ...
                        <a class="btn btn-success" href="index.php" role="button">Reset</a>
                    </div>
                </div>
            </form>
        </div>
            <div class="card-footer bg-success">
            <b class="text-black">Noted:</b><p class="text-black">Hasil Table Input Akan Muncul Dibawah, Mohon isi data dan submit terlebih dahulu</p>
              </div>
            <?php
            error_reporting(0);
        ...
        <div class="row">
          <div class="col-12">
            ...
            <?php
                $pasien1 = new bmiPasien('Alfian', 'kode', '2022-03-12', '1.com', 'P', 68, 173, 'P001');
                $pasien2 = new bmiPasien('Fauzi', 'kode', '2022-03-12', '2.com', 'P', 64, 168, 'P002');
                $pasien3 = new bmiPasien('Sofyan', 'kode', '2022-03-12', '3.com', 'P', 72, 183, 'P003');
