...
<form method="POST" style = "margin-left : 30%;">
  <div class="form-group row">
    ...
    <div class="col-7">
      <input id="text" name="nim" placeholder="" type="text" class="form-control" value="011001211" style="width: 50%">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-7">
      <input id="text1" name="nilai" placeholder="" type="text" class="form-control" value="85" style="width: 50%">
    </div>
  </div>
  <div class="form-group row">
...
$data_siswa = new NilaiMahasiswa (85, "Data Warehouse", 0110121153);
